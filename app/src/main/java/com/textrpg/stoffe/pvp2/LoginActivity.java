...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                if (loginEmail.getText().toString() == null || loginEmail.getText().toString().isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Email can't be empty", Toast.LENGTH_SHORT).show();
                }
                else if(loginPassword.getText().toString() == null || loginPassword.getText().toString().isEmpty()){
        ...
        newPassButton.setOnClickListener(new View.OnClickListener(){
            ...
            //String password2 = loginPassword.getText().toString();
            @Override
            public void onClick(View v) {
